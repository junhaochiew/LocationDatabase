...
public class MyDBHandler extends SQLiteOpenHelper {
    ...
    public void addLocations(Route location){
    ...
    public Float getBusRouteCost(String location1, String location2){
    ...
    public Float getTaxiRouteCost(String location1, String location2){
